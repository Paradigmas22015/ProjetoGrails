...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'sobrenome', 'error')} required">
	<label for="sobrenome">
...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'email', 'error')} required">
	...
	<g:textField name="email" pattern="${usuarioInstance.constraints.email.matches}" required="" value="${usuarioInstance?.email}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'telefone', 'error')} required">
	...
	<g:textField name="telefone" pattern="${usuarioInstance.constraints.telefone.matches}" required="" value="${usuarioInstance?.telefone}"/>
</div>
