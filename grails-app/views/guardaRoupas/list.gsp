...
<html>
	...
	<body>
		<a href="#list-guardaRoupas" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-guardaRoupas" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${guardaRoupasInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
